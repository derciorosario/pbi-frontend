  ...
  return (
    <aside className="w-full max-w-sm rounded-2xl border border-gray-200 bg-white shadow-sm">
      ...
      <div className="px-4 py-4 border-b border-gray-100">
        <SectionTitle
          icon={<div className="flex items-center gap-2 text-gray-800"><I.users/> <span>Connection Requests</span></div>}
          right={<Counter n={3} />}
        />
        <div className="mt-3 space-y-3">
          {[
            ...
            <div key={p.name} className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <CircleBtn style={{background: BRAND}}>
                  <I.check/>
                </CircleBtn>
                <CircleBtn className="border border-gray-200 text-gray-500 bg-white">
                  <I.close/>
                </CircleBtn>
              </div>
            </div>
      ...
      <div className="px-4 py-4 border-b border-gray-100">
        <SectionTitle
          icon={<div className="flex items-center gap-2 text-gray-800"><I.chat/> <span>Recent Chats</span></div>}
          right={
      ...
      <div className="px-4 py-4">
        <SectionTitle
          icon={<div className="flex items-center gap-2 text-gray-800"><I.calendar/> <span>Upcoming Meetings</span></div>}
          right={<Counter n={2} />}
        />
