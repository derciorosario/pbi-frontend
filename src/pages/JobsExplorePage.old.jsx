      ...
      <main className={`mx-auto ${data._openPopUps.profile ? 'relative z-50':''} max-w-7xl px-4 sm:px-6 lg:px-8 py-6 grid lg:grid-cols-12 gap-6`}>
        ...
        <div className="lg:col-span-9 grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            ...
            <PostComposer from={'job'} typeOfPosts={[ { label: "Share a Job Opening",short_label:'Post Job', Icon: Briefcase,hide:user?.accountType=="individual",type:'main'}, { label: "Highlight a career progress", Icon: Star,hide:user?.accountType=="company"}, { label: "Find Jobs", Icon: SearchIcon,hide:user?.accountType=="company"}, ]}/>
            </div>
